  ...
  return (
    <>
      <div className="flex justify-start items-center md:border-b-2 w-screen h-12 p-0 md:p-4 gap-4">
        ...
        <div
          onClick={() => handleItemClick("myassessment")}
          className={`h-12 px-0 md:px-4 py-0 md:py-4 hidden md:block myassessment ${getItemClassName(
            "myassessment"
          )}`}
        >
          My Assessments
      ...
      <div className="flex justify-start items-center w-screen gap-2 overflow-hidden mt-4 p-0 border-b-2 md:hidden">
        <span
          onClick={() => handleItemClick("myassessment")}
          className={`w-5/12 text-center pb-2 myassessment ${getItemClassName(
            "myassessment"
          )}`}
        >
          My Assessments
        ...
        <span
          onClick={() => handleItemClick("unstopassessment")}
          className={`w-6/12 text-center pb-2 myassessment ${getItemClassName(
            "unstopassessment"
          )}`}
        >
          Unstop Assessments
